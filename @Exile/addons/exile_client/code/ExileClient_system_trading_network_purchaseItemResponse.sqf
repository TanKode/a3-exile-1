...
private["_responseCode","_newPlayerMoneyString","_itemClassName","_quantity","_containerType","_containerNetID","_newPlayerMoney","_salesPrice","_containersBefore","_containersAfter","_vehicle","_dialog"];
...
{
	systemChat format["Failed to purchase item: %1", _responseCode];
};