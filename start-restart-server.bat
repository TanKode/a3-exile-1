...
start "arma3" /min /high "arma3server2.exe" "-profiles=C:\Arma3Server\Arma3Exile\config" "-BEPath=C:\Arma3Server\Arma3Exile\battleye" "-config=C:\Arma3Server\Arma3Exile\config\config.cfg" "-cfg=C:\Arma3Server\Arma3Exile\config\basic.cfg" -port=2316 -world=empty -autoinit -high -loadMissionToMemory -noSound -malloc=system -nosplash -cpuCount=4 -maxmem=3047 "-mod=@extDB2;@RyL_server;@asm"

::RESTARTING BATTLEYE
set becpath="C:\Arma3Server\Arma3Exile\bec"
cd /d %becpath%
