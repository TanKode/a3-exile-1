...
class CfgLootTables
{
	class CivillianLowerClass
	{
		...
		items[] = 
		{
			...
			{67.3, 	"acc_pointer_IR"},
			{67.6, 	"optic_MRCO"},
			{67.9, 	"H_Booniehat_dirty"},
			{68.2, 	"H_Booniehat_khk_hs"},
			{68.5, 	"H_Booniehat_dgtl"},
			{68.8, 	"6Rnd_GreenSignal_F"},
			{69.1, 	"H_Booniehat_khk"},
			{69.4, 	"H_Booniehat_indp"},
			{69.7, 	"ItemGPS"},
			{69.8, 	"Exile_Item_ChristmasTinner_Cooked"},
			{70.1, 	"H_BandMask_blk"},
			{70.3, 	"H_Bandanna_mcamo"},
			{70.4, 	"H_Bandanna_camo"},
			{70.7, 	"H_Bandanna_gry"},
			...
			{74.8, 	"H_TurbanO_blk"},
			{74.95, "Binocular"},
			{75.1, 	"H_Watchcap_camo"},
			{75.25, "V_HarnessOSpec_brn"},
			{75.4, 	"Exile_Item_InstaDoc"},
			{75.55, "V_BandollierB_rgr"},
			{75.7, 	"H_Cap_tan_specops_US"},
			{75.85, "H_Cap_brn_SPECOPS"},
			{76, 	"H_Hat_camo"},
			{76.15, "V_HarnessOGL_brn"},
			{76.25, "H_Beret_red"},
			{76.35, "H_Beret_blk"},
			{76.45, "H_Beret_02"},
			{76.55, "H_Shemag_olive_hs"},
			{76.65, "H_Beret_ocamo"},
			{76.75, "H_Shemag_tan"},
			{76.85, "H_Beret_brn_SF"},
			{76.95, "V_Chestrig_rgr"},
			{77.05, "H_Beret_grn_SF"},
	...
	class CivillianUpperClass
	{
		...
		items[] = 
		{
			...
			{61.6, 	"Exile_Item_GloriousKnakworst_Cooked"},
			{61.8, 	"Exile_Item_SausageGravy_Cooked"},
			{61.9, 	"optic_MRD"},
			{62.0, 	"optic_Yorris"},
			{62.1, 	"U_NikosBody"},
			{62.1, 	"U_NikosAgedBody"},
			{62.15, "U_OrestesBody"},
		};
	};
	...
	class Military
	{
		...
		items[] = 
		{
			...
			{65.3, 	"B_Kitbag_sgg"},
			{65.7, 	"B_Kitbag_cbr"},
			{66.1, 	"30Rnd_556x45_Stanag_Tracer_Red"},
			{66.5, 	"30Rnd_556x45_Stanag_Tracer_Yellow"},
			{66.9, 	"ItemGPS"},
			{67.3, 	"30Rnd_65x39_caseless_mag_Tracer"},
			{67.65, "SmokeShellBlue"},
			{68, 	"1Rnd_SmokeGreen_Grenade_shell"},
			{68.35, "SmokeShellYellow"},
			...
			{74.65, "U_O_PilotCoveralls"},
			{75, 	"U_B_HeliPilotCoveralls"},
			{75.35, "U_I_CombatUniform_shortsleeve"},
			{75.7, 	"1Rnd_SmokePurple_Grenade_shell"},
			{76.05, "optic_DMS"},
			{76.4, 	"UGL_FlareWhite_F"},
			{76.75, "SmokeShellRed"},
			{77.1, 	"U_I_HeliPilotCoveralls"},
			{77.45, "1Rnd_SmokeYellow_Grenade_shell"},
			{77.8, 	"U_I_CombatUniform_tshirt"},
			{78.15, "SmokeShellPurple"},
			{78.45, "arifle_TRG21_GL_F"},
			{78.75, "130Rnd_338_Mag"},
			{79.05, "H_PilotHelmetHeli_O"},
			{79.35, "H_PilotHelmetHeli_B"},
			{79.65, "H_PilotHelmetFighter_I"},
			{79.95, "H_PilotHelmetFighter_O"},
			{80.25, "H_PilotHelmetFighter_B"},
			{80.55, "H_CrewHelmetHeli_B"},
			{80.85, "H_CrewHelmetHeli_O"},
			{81.15, "H_CrewHelmetHeli_I"},
			{81.45, "1Rnd_HE_Grenade_shell"},
			{81.75, "V_RebreatherIA"},
			{82.05, "V_RebreatherIR"},
			{82.35, "V_RebreatherB"},
			{82.65, "U_B_SpecopsUniform_sgg"},
			{82.95, "arifle_Mk20_GL_F"},
			{83.25, "H_PilotHelmetHeli_I"},
			{83.45, "U_B_Wetsuit"},
			{83.75, "U_O_Wetsuit"},
			{84, 	"srifle_DMR_01_F"},
			{84.25, "srifle_EBR_F"},
			...
			{85, 	"muzzle_snds_H"},
			{85.25, "muzzle_snds_M"},
			{85.45, "5Rnd_127x108_Mag"},
			{85.75, "H_BandMask_demon"},
			{86, 	"H_BandMask_reaper"},
			{86.25, "H_BandMask_khk"},
			{86.5, 	"7Rnd_408_Mag"},
			{86.75, "muzzle_snds_B"},
			{87, 	"HandGrenade"},
			{87.25, "H_HelmetB_camo"},
			{87.45, "U_I_OfficerUniform"},
			{87.65, "U_O_OfficerUniform_ocamo"},
			{88.05, "B_FieldPack_blk"},
			{88.25, "B_FieldPack_ocamo"},
			{88.45, "arifle_MXM_Black_F"},
			{88.65, "B_FieldPack_oucamo"},
			{88.85, "B_FieldPack_cbr"},
			{89.05, "arifle_MXC_Black_F"},
			{89.25, "arifle_MX_Black_F"},
			{89.45, "arifle_MX_GL_Black_F"},
			{89.8, 	"U_O_SpecopsUniform_blk"},
			{89.95, "3Rnd_SmokeYellow_Grenade_shell"},
			{90.1, 	"B_Bergen_blk"},
			{90.25, "U_O_CombatUniform_ocamo"},
			{90.4, 	"B_Bergen_rgr"},
			{90.55, "3Rnd_UGL_FlareRed_F"},
			{90.7, 	"B_Bergen_mcamo"},
			{90.85, "3Rnd_UGL_FlareYellow_F"},
			{91, 	"B_Bergen_sgg"},
			{91.15, "U_I_GhillieSuit"},
			{91.3, 	"3Rnd_Smoke_Grenade_shell"},
			{91.45, "U_B_GhillieSuit"},
...
class CfgSettings
{
	...
	class BambiSettings
	{
		...
		spawnZoneVehicles[] =
		{
			{2, "Exile_Bike_QuadBike_Black"},
			{2, "Exile_Bike_QuadBike_Red"},
			{2, "Exile_Bike_QuadBike_White"},
			{2, "Exile_Bike_QuadBike_Blue"},
			{1, "Exile_Bike_QuadBike_Guerilla01"},
			{1, "Exile_Bike_QuadBike_Guerilla02"}
		};
	};
	...
	class Weather
	{
		...
		*/
		keyframes[] = {"Sunny", "Sunny", "Sunny", "Sunny", "Sunny", "Cloudy", "Cloudy", "Cloudy", "Rainy", "Rainy", "Thunderstorm"};
