...
//Add tool items
_toolsArray = missionNamespace getVariable ["A3XAI_tools"+str(_unitLevel),[]];
{
	_item = _x select 0;
...
if (A3XAI_debugLevel > 1) then {diag_log format ["A3XAI Debug: Generated loot for AI death: %1,%2,%3.",_weaponLoot,_loot,_toolLoot];};
