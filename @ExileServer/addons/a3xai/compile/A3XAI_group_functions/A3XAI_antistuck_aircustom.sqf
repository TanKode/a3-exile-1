...
if ((((_leader distance2D (_leader findNearestEnemy _vehicle)) > NEAREST_ENEMY_RANGE) or {_checkPos call A3XAI_checkInNoAggroArea}) && {_checkPos isEqualTo (_unitGroup getVariable ["antistuckPos",[0,0,0]])} && {canMove _vehicle}) then {
